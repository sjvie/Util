...
# --- Configuration ---
TARGET_BASHRC="$HOME/.inputrc"
# IMPORTANT: Replace this URL with the raw URL of your custom bashrc file on GitHub
GITHUB_URL="https://raw.githubusercontent.com/sjvie/Util/refs/heads/main/linux_setup/my_inputrc"

START_MARKER="######## sjvie CUSTOM ~/.inputrc"
END_MARKER="######## END sjvie CUSTOM ~/.inputrc"
...
if curl -sSL -o "$DOWNLOADED_CUSTOM_PART_FILE" "$GITHUB_URL"; then
    ...
    echo "Error: Failed to download custom inputrc from '$GITHUB_URL'." >&2
